...
使用方式:
  python solar_train_rope_v2.py                          # 完整流程
  python solar_train_rope_v2.py --mode train             # 仅训练
  python solar_train_rope_v2.py --mode evaluate          # 仅评估
  python solar_train_rope_v2.py --noise-std 0.02         # 调整噪声强度
"""
